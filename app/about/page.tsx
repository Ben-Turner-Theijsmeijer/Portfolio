        ...
        <div className="w-full max-w-[1600px] mx-auto">
            <div className="py-25 lg:px-15 xl:px-25 flex flex-col md:flex-row items-center justify-around -z-5 p-8 overflow-hidden">
                <div className="md:w-3/5">
                    <h1 className="text-5xl sm:text-6xl font-bold mb-2">Hi, <span className="text-[var(--accent3)] hover:text-[var(--accent4)] duration-700">I’m Ben Turner-Theijsmeijer</span></h1>
